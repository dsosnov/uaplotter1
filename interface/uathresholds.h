...
//       }
  ...
  inline std::vector<float> const THR_PFEN_SUME(){
    ...
    std::vector<float> pf_2_8_pbp_unified = { 0, 0, 0, 0, 0, 0, 0, 14.7, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 14.7, 0, 0, 0, 0, 0, 0, 0 }; // Run2, 8TeV Pbp (Pb-> <-p) [new thresholds, unified for central region]
    std::vector<float> pf_2_8_ppb_unified = { 0, 0, 0, 0, 0, 0, 0, 14.7, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 6.6, 14.7, 0, 0, 0, 0, 0, 0, 0 }; // Run2, 8TeV pPb (p-> <-Pb) [new thresholds, unified for central region]
    auto thr_p = &t0;
    switch (_run){
      case 1: {
        thr_p = &pf_1;
